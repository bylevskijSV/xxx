...
pizza7 = Pizza.create(name: "Курица и сладкий перчик", price: 12, ingredients: "томатный соус, сыр моцарелла, филе куриное в/к, бекон в/к, сладкий перчик, орегано", description: "вкусно", weight: 480, photo: "chicken", popularity: 3)
